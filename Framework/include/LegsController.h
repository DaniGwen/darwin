...
namespace Robot
{
    ...
    public:
        ...
        void Stand(int moving_speed = 200, int p_gain = 100);
        void ReadyToPickUpItem(int moving_speed = 200, int p_gain = 100);
    ...
    private:
        ...
        void SetPID(int moving_speed = 200, int p_gain = 100);
    };
}
