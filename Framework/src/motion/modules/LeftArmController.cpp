...
namespace Robot
{
    ...
    void LeftArmController::InitializeLeftArm(int p_gain, int d_gain)
    {
        ...
        cm730_->WriteByte(JointData::ID_L_SHOULDER_ROLL, MX28::P_MOVING_SPEED_L, 6, 0);
        cm730_->WriteByte(JointData::ID_L_SHOULDER_PITCH, MX28::P_MOVING_SPEED_L, 6, 0);
        cm730_->WriteByte(JointData::ID_L_ELBOW, MX28::P_MOVING_SPEED_L, 6, 0);
