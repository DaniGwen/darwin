...
const char *MODEL_PATH = "/home/darwin/darwin/aiy-maker-kit/examples/models/ssd_mobilenet_v2_coco_quant_postprocess_edgetpu.tflite"; // IMPORTANT: Path to your Edge TPU model
...
        bool target_found = false;
        ...
          // Example: ID for "person" - find this from your labels
