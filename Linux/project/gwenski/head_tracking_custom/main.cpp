...
int run_main_loop(int client_sock, mjpg_streamer* streamer, minIni* ini)
{
    ...
    Head::GetInstance()->m_Joint.SetPGain(JointData::ID_HEAD_PAN, 10); // Set P-gain for pan
    Head::GetInstance()->m_Joint.SetPGain(JointData::ID_HEAD_TILT, 10); // Set P-gain for tilt
