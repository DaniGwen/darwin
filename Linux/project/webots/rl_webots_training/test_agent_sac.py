import os
import numpy as np
# --- CHANGE 1: Import the SAC algorithm instead of TD3 ---
...
if __name__ == '__main__':
    ...
    while True:
        model_path = input("Enter the path to the trained SAC .zip model to test: ")
    ...
    try:
        # --- CHANGE 2: Load the model as an SAC agent ---
        model = SAC.load(model_path, env=env)
        print("Model loaded successfully as an SAC agent.")
